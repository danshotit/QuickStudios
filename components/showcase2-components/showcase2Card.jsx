...
const Showcase2Card = ({ src, href, title }) => {
  return (
    ...
    >
      <div className="z-40 w-full h-full top-4 opacity-0 hover:opacity-100 transition-all duration-500 max-sm:top-2 max-sm:right-2 right-4 absolute pt-72 pl-10 bg-green-500">
        <Link
          onClick={scrollToTop}
          to={href}
