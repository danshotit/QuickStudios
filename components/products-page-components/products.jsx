      ...
      >
        ...
        <div className="w-2/4 max-lg:w-full relative">
          ...
          >
            ...
            <div>
              <h2 className="text-xl text-green-500 font-semibold">Price:</h2>
              <h2 className="text-2xl mt-2 font-semibold">
                KES {formatCompactNumber(price)}/Month
              </h2>
            </div>
            <div className="flex flex-col gap-2">
              <h2 className="text-xl text-green-500 font-semibold">Quantity</h2>

              <NumberInput
                borderColor={"#048424"}
                focusBorderColor="#048424"
              ...
              <Button
                // _hover={{ borderColor: "#048424" }}
                _hover={{ backgroundColor: "white", color: "#048424" }}
                backgroundColor={"#048424"}
                color={"white"}
                borderColor={"#048424"}
                variant={"outline"}
                size={"lg"}
            ...
            <div className="flex text-xl flex-col gap-2">
              <h2 className=" text-green-500 font-semibold">Details</h2>
              <p>{descr}</p>
