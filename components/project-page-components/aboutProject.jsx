    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="">
            ...
            <div className="text-xl text-green-500 flex gap-3">
              <a
                style={{ borderWidth: 1 }}
                className="w-12 h-12  border-green-500 rounded-full  flex justify-center  items-center"
                href=""
              >
                <FaFacebookF />
              </a>
      ...
      <div className=" flex">
        <Link
          ...
          to={project.prevHref}
          id="prev-btn"
          className="w-2/5  hover:text-green-500  py-7 flex justify-center items-center gap-3"
        >
