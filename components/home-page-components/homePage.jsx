      ...
      <div className="  flex bg-[url('/hero-bg-image.jpg')] pt-36 pb-20 bg-top bg-no-repeat bg-cover  ">
        ...
        >
          <motion.h1
            ...
            className="text-6xl max-lg:mx-auto font-semibold max-sm:text-6xl max-w-lg "
          >
             Quick Studios
          </motion.h1>
          <motion.p
          ...
          >
            To democratize creative expression by offering sustainable and affordable studio spaces equipped with
          ...
          >
            ...
            <div className="flex gap-12 max-sm:flex-wrap  justify-center">
              <div className="flex justify-start items-center gap-2">
                ...
                <h2 className="text-2xl">Ism Homes</h2>
              </div>
              {/*--<div className="flex justify-start items-center gap-2">
              ...
              <div className="flex justify-start items-center gap-2">
                <img className="w-9" src="/qslogo.png" alt="img" />
                <h2 className="text-2xl">Quick Studios</h2>
              </div>
            </div>
          </motion.div>
        </motion.div>
          ...
          <div className="w-2/4 max-md:w-full ">
            ...
            >
              <h2 className="text-5xl max-md:text-4xl font-bold title-font">
                We offer access to quality co-studio spaces 
                <span className=" text-green-500 title-font "> since 2024</span>
              </h2>
            </motion.div>
          </div>
          <div className="w-2/4 max-md:w-full">
            ...
            >
              <p className="text-xl">
              The core problem our business aims to solve is the lack of accessible,
               affordable, and high-quality studio spaces for youth, 
              emerging artists, and creative entrepreneurs.
              </p>
      ...
      <div className="bg-gray-100">
        ...
        >
          ...
          >
            ...
            <p className="text-xl">
            By repurposing recycled transportation containers and partnering with Airbnb hosts, our business seeks to offer cost-effective, 
            customizable studio solutions that are conveniently located and environmentally responsible. 
          ...
          >
            <div className="flex flex-col gap-7 ">
              <WhatWeDoCard
                ...
                iconAlt={"Environmentally responsible"}
                title={"Environmentally responsible"}
                desc={
                  "Commitment to environmental sustainability through the use of recycled materials and energy efficient practices"
                }
              />
              <WhatWeDoCard
                ...
                desc={
                  "Social impact through enabling affordable access to high-quality studio spaces for aspiring creatives"
                }
              />
            </div>
            <div className="flex flex-col gap-7">
              ...
              <WhatWeDoCard
                ...
                iconAlt={"Conveniently located"}
                title={"Conveniently located"}
                desc={
                  "Selecting strategic locations based on accessibility, demand, and regulatory considerations. Prioritizing areas with vibrant creative communities."
                }
              />
              <div
                style={{ height: 130 }}
        ...
        >
          ...
          >
            <h1 className="text-5xl max-md:text-4xl font-semibold">
              Why do people love quick studios
            </h1>
            <div>
              <Carousel />
            </div>
