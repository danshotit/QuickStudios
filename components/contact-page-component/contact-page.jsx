    ...
    <div className=" w-full overflow-hidden">
      ...
      >
        ...
        >
          ...
          />
          <Button
            _hover={{ backgroundColor: "white", color: "#117f1d" }}
            backgroundColor={"#117f1d"}
            color={"white"}
            borderColor={"#117f1d"}
            variant={"outline"}
            size={"lg"}
        ...
        >
          <div className="text-5xl max-md:text-4xl max-md:text-center">
            <h1 className="font-semibold ">
              Contact our support{" "}
              <span className="font-semibold title-font  text-green-500">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex  gap-3 text-xl items-center">
              <div>
                <FaPhone className="rotate-90 text-green-500" />
              </div>
              <p>+254112477747</p>
            </div>
            <div className="flex  gap-3 text-xl items-center">
            ...
            <div className="absolute flex justify-center items-center  bg-white/90  top-0 left-0 right-0 bottom-0">
              ...
              >
                <h1 className="text-[46px] max-lg:text-4xl max-sm:text-[34px] max-[500px]:text-3xl leading-tight font-semibold">
                  ...
                  <br /> will definitely get a co-studio space.
                </h1>
                <p className="text-xl mt-3">
                
              Accessibility to affordable, and high-quality studio spaces for youth, 
